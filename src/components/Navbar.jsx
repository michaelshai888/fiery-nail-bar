  ...
  return (
    <nav className={`navbar${scrolled ? ' navbar--scrolled' : ''}`} aria-label="Main navigation">
      <div className="navbar__inner container">
        {/* Left links — right-aligned so they sit next to the logo */}
        ...
        <div className="navbar__side navbar__side--right">
          ...
          <a href="#booking" className="btn btn-pink navbar__cta">Book Now</a>
      ...
      {open && (
        <div className="navbar__drawer">
          ...
          <a href="#booking" className="btn btn-pink" onClick={close}>Book Now</a>
